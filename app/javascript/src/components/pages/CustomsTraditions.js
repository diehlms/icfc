...
export default function CustomsTraditions() {
    return (
        <div className="containerMain">
            ...
            />
            <SmallText text="Iron City Fishing Club had its origin in 1881. It had then and still has religious overtones and a few established traditions that have made it and kept it the happy summer retreat it is." />
            <HorizontalLine />
            <div style={{
                display: 'grid',
                ...
                <div>
                    <SubTitle text="Customs & Traditions" /> 
