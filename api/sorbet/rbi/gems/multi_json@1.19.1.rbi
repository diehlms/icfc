...
# @api private
#
# source://multi_json//lib/multi_json/adapter.rb#16
class MultiJson::Adapter
  ...
  class << self
    ...
    # @return [void]
    #
    # source://multi_json//lib/multi_json/adapter.rb#29
    ...
    #
    # source://multi_json//lib/multi_json/adapter.rb#52
    def load(string, options = T.unsafe(nil)); end
    ...
    #
    # source://multi_json//lib/multi_json/adapter.rb#76
    def blank?(input); end
    ...
    #
    # source://multi_json//lib/multi_json/adapter.rb#88
    ...
    # @return [Hash] merged options hash
    #
    # source://multi_json//lib/multi_json/adapter.rb#100
    ...
    #
    # source://multi_json//lib/multi_json/adapter.rb#112
...
# source://multi_json//lib/multi_json/adapters/json_gem.rb#5
...
class MultiJson::Adapters::JsonGem < ::MultiJson::Adapter
  ...
  # @return [String] JSON string
  #
  # source://multi_json//lib/multi_json/adapters/json_gem.rb#45
  def dump(object, options = T.unsafe(nil)); end
  ...
  # @return [Object] parsed Ruby object
  #
  # source://multi_json//lib/multi_json/adapters/json_gem.rb#29
  def load(string, options = T.unsafe(nil)); end
end

# source://multi_json//lib/multi_json/adapters/json_gem.rb#12
