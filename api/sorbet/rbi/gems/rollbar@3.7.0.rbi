...
module Rollbar
  class << self
    ...
    # source://rollbar//lib/rollbar.rb#33
...
class Rollbar::Configuration
  ...
  # source://rollbar//lib/rollbar/configuration.rb#206
  def clone; end
  ...
  # source://rollbar//lib/rollbar/configuration.rb#205
  ...
  # Returns the value of attribute safely.
  #
  # source://rollbar//lib/rollbar/configuration.rb#87
  def safely?; end
...
class Rollbar::Item
  ...
  # source://rollbar//lib/rollbar/item.rb#29
  def [](*args, **_arg1, &block); end

  # source://rollbar//lib/rollbar/item.rb#180
  def add_access_token_to_payload(payload); end

  # source://rollbar//lib/rollbar/item.rb#57
  def build; end

  # source://rollbar//lib/rollbar/item.rb#66
  def build_data; end

  # source://rollbar//lib/rollbar/item.rb#98
  ...
  # source://rollbar//lib/rollbar/item.rb#115
  def configured_options; end
  ...
  # source://rollbar//lib/rollbar/item.rb#133
  def dump; end
  ...
  # source://rollbar//lib/rollbar/item.rb#147
  def handle_too_large_payload(stringified_payload, _final_payload, attempts); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/item.rb#171
  def ignored?; end

  # source://rollbar//lib/rollbar/item.rb#81
  def initial_data; end

  # Returns the value of attribute is_uncaught.
  #
  # source://rollbar//lib/rollbar/item.rb#26
  def is_uncaught; end
  ...
  # source://rollbar//lib/rollbar/item.rb#53
  def payload; end
  ...
  # source://rollbar//lib/rollbar/item.rb#209
  def build_backtrace_body; end

  # source://rollbar//lib/rollbar/item.rb#205
  def build_body; end

  # source://rollbar//lib/rollbar/item.rb#198
  def build_environment; end

  # source://rollbar//lib/rollbar/item.rb#218
  def build_extra; end

  # source://rollbar//lib/rollbar/item.rb#272
  def build_message_body; end

  # source://rollbar//lib/rollbar/item.rb#248
  def custom_data; end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/item.rb#244
  def custom_data_method?; end

  # source://rollbar//lib/rollbar/item.rb#291
  def enforce_valid_utf8; end

  # source://rollbar//lib/rollbar/item.rb#229
  def error_context; end

  # source://rollbar//lib/rollbar/item.rb#262
  def report_custom_data_error(e); end

  # source://rollbar//lib/rollbar/item.rb#233
  def scrub(data); end

  # source://rollbar//lib/rollbar/item.rb#280
  def server_data; end

  # source://rollbar//lib/rollbar/item.rb#295
  def transform; end

  # source://rollbar//lib/rollbar/item.rb#309
...
class Rollbar::Item::Backtrace
  ...
  # source://rollbar//lib/rollbar/item/backtrace.rb#31
  def build; end
...
class Rollbar::Notifier
  ...
  # See log() above
  #
  # source://rollbar//lib/rollbar/notifier.rb#203
  def critical(*args); end

  # source://rollbar//lib/rollbar/notifier.rb#391
  def current_bindings; end

  # See log() above
  #
  # source://rollbar//lib/rollbar/notifier.rb#178
  def debug(*args); end

  # source://rollbar//lib/rollbar/notifier.rb#404
  def disable_locals; end

  # source://rollbar//lib/rollbar/notifier.rb#400
  def enable_locals; end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#395
  def enable_locals?; end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#207
  def enabled?; end

  # See log() above
  #
  # source://rollbar//lib/rollbar/notifier.rb#198
  def error(*args); end

  # source://rollbar//lib/rollbar/notifier.rb#387
  def exception_bindings; end

  # source://rollbar//lib/rollbar/notifier.rb#320
  def failsafe_add_original_error_data(payload_notifier, original_error); end

  # source://rollbar//lib/rollbar/notifier.rb#276
  def failsafe_initial_data(exception_reason); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#152
  def ignore_before_process?(level, exception, message, extra); end

  # See log() above
  #
  # source://rollbar//lib/rollbar/notifier.rb#183
  def info(*args); end
  ...
  # source://rollbar//lib/rollbar/notifier.rb#374
  ...
  # source://rollbar//lib/rollbar/notifier.rb#906
  def log_warning(message); end

  # source://rollbar//lib/rollbar/notifier.rb#379
  def logger; end
  ...
  # source://rollbar//lib/rollbar/notifier.rb#312
  ...
  #
  # source://rollbar//lib/rollbar/notifier.rb#251
  def process_from_async_handler(payload); end

  # source://rollbar//lib/rollbar/notifier.rb#214
  ...
  # source://rollbar//lib/rollbar/notifier.rb#163
  def report_with_rescue(level, message, exception, extra, context, is_uncaught); end
  ...
  # source://rollbar//lib/rollbar/notifier.rb#294
  ...
  # source://rollbar//lib/rollbar/notifier.rb#383
  ...
  # See log() above
  #
  # source://rollbar//lib/rollbar/notifier.rb#188
  def warn(*args); end

  # See log() above
  #
  # source://rollbar//lib/rollbar/notifier.rb#193
  def warning(*args); end

  private

  # source://rollbar//lib/rollbar/notifier.rb#889
  def async_failover(item); end

  # Payload building functions
  #
  # source://rollbar//lib/rollbar/notifier.rb#583
  def build_item(level, message, exception, extra, context, is_uncaught); end

  # source://rollbar//lib/rollbar/notifier.rb#424
  def call_before_process(options); end

  # source://rollbar//lib/rollbar/notifier.rb#867
  def default_async_handler; end

  # source://rollbar//lib/rollbar/notifier.rb#659
  def do_post(uri, body, access_token); end

  # source://rollbar//lib/rollbar/notifier.rb#780
  def do_write_item(item); end

  # source://rollbar//lib/rollbar/notifier.rb#617
  def eventmachine_callback(req); end

  # source://rollbar//lib/rollbar/notifier.rb#628
  def eventmachine_errback(req); end

  # source://rollbar//lib/rollbar/notifier.rb#452
  def extract_arguments(args); end

  # source://rollbar//lib/rollbar/notifier.rb#851
  def failsafe_body(reason); end

  # source://rollbar//lib/rollbar/notifier.rb#833
  ...
  # source://rollbar//lib/rollbar/notifier.rb#801
  def file_name_with_pid(configuration); end

  # source://rollbar//lib/rollbar/notifier.rb#495
  def filtered_level(exception); end

  # source://rollbar//lib/rollbar/notifier.rb#746
  def handle_net_retries; end

  # source://rollbar//lib/rollbar/notifier.rb#760
  def handle_response(response); end

  # source://rollbar//lib/rollbar/notifier.rb#722
  def http_proxy(uri); end

  # source://rollbar//lib/rollbar/notifier.rb#711
  def http_proxy_for_em(uri); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#487
  def ignored?(exception, use_exception_level_filters = T.unsafe(nil)); end

  # source://rollbar//lib/rollbar/notifier.rb#674
  def init_http(uri); end

  # source://rollbar//lib/rollbar/notifier.rb#689
  def init_http_timeouts(http); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#474
  def java_exception?(obj); end

  # source://rollbar//lib/rollbar/notifier.rb#524
  def log_and_return_item_data(item); end

  # source://rollbar//lib/rollbar/notifier.rb#533
  ...
  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#707
  def multibyte?(str); end

  # source://rollbar//lib/rollbar/notifier.rb#742
  def null_proxy; end

  # source://rollbar//lib/rollbar/notifier.rb#442
  def options_for_handler(options); end

  # source://rollbar//lib/rollbar/notifier.rb#694
  def pack_ruby260_bytes(body); end

  # source://rollbar//lib/rollbar/notifier.rb#873
  def process_async_item(item); end

  # source://rollbar//lib/rollbar/notifier.rb#726
  def proxy_from_config; end

  # source://rollbar//lib/rollbar/notifier.rb#738
  def proxy_from_env(uri); end

  # source://rollbar//lib/rollbar/notifier.rb#506
  def report(level, message, exception, extra, context, is_uncaught); end
  ...
  #
  # source://rollbar//lib/rollbar/notifier.rb#541
  def report_internal_error(exception, original_error = T.unsafe(nil)); end

  # source://rollbar//lib/rollbar/notifier.rb#855
  def schedule_item(item); end

  # source://rollbar//lib/rollbar/notifier.rb#651
  def send_body(body); end

  # source://rollbar//lib/rollbar/notifier.rb#637
  def send_item(item); end

  # Delivery functions
  #
  # source://rollbar//lib/rollbar/notifier.rb#605
  def send_using_eventmachine(body); end

  # source://rollbar//lib/rollbar/notifier.rb#564
  def skip_reporting_internal_error(exception); end

  # source://rollbar//lib/rollbar/notifier.rb#772
  def ssl_verify_mode; end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#418
  def uncaught?(options); end

  # source://rollbar//lib/rollbar/notifier.rb#809
  def update_file(file, file_name); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#410
  def use_exception_level_filters?(options); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/notifier.rb#917
