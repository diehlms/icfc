...
class ActiveModel::SerializableResource
  class << self
    # source://active_model_serializers//lib/active_model/serializable_resource.rb#10
...
class ActiveModel::Serializer
  ...
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#322
  def initialize(object, options = T.unsafe(nil)); end

  # source://active_model_serializers//lib/active_model/serializer.rb#184
  def _links; end

  # source://active_model_serializers//lib/active_model/serializer.rb#184
  def _links?; end

  # source://active_model_serializers//lib/active_model/serializer.rb#186
  def _meta; end

  # source://active_model_serializers//lib/active_model/serializer.rb#186
  def _meta?; end

  # source://active_model_serializers//lib/active_model/serializer.rb#182
  def _reflections; end

  # source://active_model_serializers//lib/active_model/serializer.rb#182
  def _reflections?; end

  # source://active_model_serializers//lib/active_model/serializer.rb#187
  def _type; end
  ...
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#383
  ...
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#351
  def associations(include_directive = T.unsafe(nil), include_slice = T.unsafe(nil)); end

  # @api private
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#417
  def associations_hash(adapter_options, options, adapter_instance); end

  # Return the +attributes+ of +object+ as presented
  # by the serializer.
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#339
  def attributes(requested_attrs = T.unsafe(nil), reload = T.unsafe(nil)); end

  # @api private
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#406
  def attributes_hash(_adapter_options, options, adapter_instance); end

  # source://active_model_serializers//lib/active_model/serializer.rb#16
  def config; end
  ...
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#388
  def json_key; end
  ...
  # source://active_model_serializers//lib/active_model/serializer.rb#397
  ...
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#369
  def serializable_hash(adapter_options = T.unsafe(nil), options = T.unsafe(nil), adapter_instance = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#333
  def success?; end
  ...
  # @return [Hash] containing the attributes and first level
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#379
  ...
  #
  # source://active_model_serializers//lib/active_model/serializer.rb#428
  ...
  class << self
    ...
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#200
    def _attributes; end

    # source://active_model_serializers//lib/active_model/serializer.rb#178
    ...
    # source://active_model_serializers//lib/active_model/serializer.rb#36
    def _cache; end
    ...
    # source://active_model_serializers//lib/active_model/serializer.rb#63
    ...
    #   end
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#229
    ...
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#209
    ...
    # @return [void]
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#252
    ...
    # @api private
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#86
    ...
    # @return [void]
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#241
    ...
    # @return [void]
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#263
    def has_one(name, options = T.unsafe(nil), &block); end

    # @api private
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#106
    def include_directive_from_options(options); end

    # @private
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#190
    ...
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#288
    ...
    #   end
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#303
    def meta(value = T.unsafe(nil), &block); end

    # @api private
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#117
    ...
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#45
    ...
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#76
    ...
    #   type 'authors'
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#311
    def type(type); end
    ...
    # @return [void]
    #
    # source://active_model_serializers//lib/active_model/serializer.rb#272
...
module ActiveModel::Serializer::Adapter
  class << self
    # source://active_model_serializers//lib/active_model/serializer/adapter.rb#15
...
class ActiveModel::Serializer::Adapter::Attributes
  ...
  class << self
    # source://active_model_serializers//lib/active_model/serializer/adapter/attributes.rb#12
...
class ActiveModel::Serializer::Adapter::Base
  ...
  class << self
    # source://active_model_serializers//lib/active_model/serializer/adapter/base.rb#9
...
class ActiveModel::Serializer::Adapter::Json
  ...
  class << self
    # source://active_model_serializers//lib/active_model/serializer/adapter/json.rb#12
    def _deprecated_new(*_arg0); end
...
class ActiveModel::Serializer::Adapter::JsonApi
  ...
  class << self
    # source://active_model_serializers//lib/active_model/serializer/adapter/json_api.rb#12
    def _deprecated_new(*_arg0); end
...
class ActiveModel::Serializer::Adapter::Null
  ...
  class << self
    # source://active_model_serializers//lib/active_model/serializer/adapter/null.rb#12
    def _deprecated_new(*_arg0); end
...
class ActiveModel::Serializer::ArraySerializer < ::ActiveModel::Serializer::CollectionSerializer
  class << self
    # source://active_model_serializers//lib/active_model/serializer/array_serializer.rb#10
    def _deprecated_new(*_arg0); end
...
module ActiveModel::Serializer::Caching::ClassMethods
  ...
  # @return [true, false]
  #
  # source://active_model_serializers//lib/active_model/serializer/concerns/caching.rb#142
  def perform_caching?; end
end
...
class ActiveModel::Serializer::LazyAssociation < ::Struct
  ...
  # @api private
  #
  # source://active_model_serializers//lib/active_model/serializer/lazy_association.rb#22
...
#
# source://active_model_serializers//lib/active_model/serializer.rb#23
...
module ActiveModelSerializers::Deprecate
  ...
  class << self
    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#54
    def delegate_and_deprecate(method, delegee); end
    ...
    # telling the user of +replacement+ (unless +replacement+ is :none) that it is planned to go away.
    #
    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#53
    def deprecate(name, replacement); end
  end
end
...
class ActiveModelSerializers::Model
  ...
  # source://active_model_serializers//lib/active_model_serializers/model.rb#10
  def __callbacks; end
  ...
  # source://active_model_serializers//lib/active_model_serializers/model.rb#9
...
class ActiveModelSerializers::Railtie < ::Rails::Railtie
  # :nocov:
  #
  # source://active_model_serializers//lib/active_model_serializers/railtie.rb#47
  def extend_action_controller_test_case(&block); end
end
...
class ActiveModelSerializers::SerializableResource
  ...
  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#8
  def __callbacks; end

  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#8
  def __callbacks?; end

  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#12
  def _notifying_render_as_json(*_arg0, **_arg1, &_arg2); end

  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#11
  def _notifying_render_serializable_hash(*_arg0, **_arg1, &_arg2); end

  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#13
  ...
  # NOTE: if no adapter is available, returns the resource itself. (i.e. adapter is a no-op)
  #
  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#39
  ...
  # Remove :each_serializer if present and set as :serializer key
  #
  # source://active_model_serializers//lib/active_model_serializers/serializable_resource.rb#68
  def serializer_class; end
