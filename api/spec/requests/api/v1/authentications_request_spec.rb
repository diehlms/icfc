...
RSpec.describe 'Api::V1::Authentications', type: :request do
  ...
  describe 'POST /api/v1/authentications/login' do
    context 'with valid credentials' do
      it 'returns a JWT token' do
        post '/api/v1/authentications/login', params: valid_login_params
    ...
    context 'with invalid email' do
      it 'returns unauthorized' do
        post '/api/v1/authentications/login', params: { email: 'nonexistent@example.com', password: 'password' }
    ...
    context 'with invalid password' do
      it 'returns unauthorized' do
        post '/api/v1/authentications/login', params: invalid_login_params
        expect(response).to have_http_status(:unauthorized)
    ...
    context 'with missing parameters' do
      it 'returns unauthorized for missing email' do
        post '/api/v1/authentications/login', params: { password: 'password' }
        expect(response).to have_http_status(:unauthorized)
      end

      it 'returns unauthorized for missing password' do
        post '/api/v1/authentications/login', params: { email: user.email }
        expect(response).to have_http_status(:unauthorized)
      end
    end
    ...
    context 'with case insensitive email' do
      it 'finds user regardless of email case' do
        post '/api/v1/authentications/login', params: { email: user.email.upcase, password: 'StrongPass123' }
        expect(response).to have_http_status(:ok)
      end
    end
  ...
  describe 'POST /api/v1/authentications/signup' do
    context 'with valid parameters' do
      ...
      it 'creates a new user' do
        expect {
          post '/api/v1/authentications/signup', params: valid_signup_params
    ...
    context 'with invalid parameters' do
      it 'does not create a user' do
        expect {
          post '/api/v1/authentications/signup', params: invalid_signup_params
    ...
    context 'with duplicate email' do
      ...
      it 'returns validation error' do
        ...
        post '/api/v1/authentications/signup', params: params
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe 'GET /api/v1/authentications/confirm_email' do
    ...
    context 'with valid confirmation token' do
      ...
      it 'activates the user email' do
        get '/api/v1/authentications/confirm_email/valid-token'
        expect(response).to have_http_status(:ok)
    ...
    context 'with invalid confirmation token' do
      ...
      it 'returns not found' do
        get '/api/v1/authentications/confirm_email/invalid-token'
  ...
  describe 'parameter handling' do
    it 'accepts all permitted user parameters' do
      params = {
        user: {
          username: 'testuser',
          firstname: 'Test',
  ...
  describe 'error handling' do
    context 'when user creation fails' do
      before do
        ...
        allow_any_instance_of(User).to receive(:errors).and_return(['Error message'])
      end
