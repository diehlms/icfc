...
import type { familyTreeIn } from '../models/familyTreeIn';
...
export class FamilyTreesService {
     ...
     * @throws ApiError
     */
    public postV1FamilyTrees(
        requestBody?: familyTreeIn,
     ...
     * @throws ApiError
     */
    public getV1FamilyTrees1(
        id: number,
    ): CancelablePromise<familyTreeOut> {
        return this.httpRequest.request({
            method: 'GET',
