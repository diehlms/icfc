...
export class PasswordResetsService {
	 ...
	 * @throws ApiError
	 */
	public getV1PasswordResets1(id: string): CancelablePromise<any> {
		return this.httpRequest.request({
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public patchV1PasswordResets(id: string): CancelablePromise<any> {
		return this.httpRequest.request({
			method: 'PATCH',
			url: '/v1/password_resets/{id}',
			path: {
	 ...
	 * @throws ApiError
	 */
	public putV1PasswordResets(id: string): CancelablePromise<any> {
		return this.httpRequest.request({
			method: 'PUT',
			url: '/v1/password_resets/{id}',
			path: {
