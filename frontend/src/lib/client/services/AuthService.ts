...
export class AuthService {
	 ...
	 * @throws ApiError
	 */
	public postV1AuthLogin(requestBody?: loginPayload): CancelablePromise<loginPayload> {
	 ...
	 * @throws ApiError
	 */
	public postV1AuthSignup(requestBody?: signupPayload): CancelablePromise<signupPayload> {
		return this.httpRequest.request({
			method: 'POST',
			url: '/v1/auth/signup',
			body: requestBody,
	 ...
	 * @throws ApiError
	 */
	public postV1AuthConfirmEmail(token: string): CancelablePromise<any> {
		return this.httpRequest.request({
			method: 'POST',
