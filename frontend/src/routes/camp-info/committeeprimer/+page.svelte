<div>
  <h1 class="text-3xl font-bold my-4">Committee Primer FAQ</h1>

  <div class="text-container mt-4">
    <h4 class="text-xl font-semibold">How does a person get selected for a committee?</h4>
    <ul class="list-disc list-inside">
      <li>
        As stated in the By-Laws, the President appoints all committees and designates chairmen thereof, and serves as an Ex-officio Member of each committee. However, he/she usually asks the chairs to draw up lists of members for his/her approval.
      </li>
    ...
    <h4 class="text-xl font-semibold mt-4">How often do committees meet?</h4>
    <ul class="list-disc list-inside">
      ...
      <li>
        The fact that Committee Members are not in camp at the same time and people are geographically dispersed presents challenges for normal or regular committee operations. Committees need to be creative and flexible. The most effective committees engage in regular and timely communication with all committee members.
      </li>
    </ul>

    <h4 class="text-xl font-semibold mt-4">It seems like committee membership doesn’t change.</h4>
    <ul class="list-disc list-inside">
    ...
    <h4 class="text-xl font-semibold mt-4">Is there an average size of membership or maximum number for committees?</h4>
    <ul class="list-disc list-inside">
      <li>There is no formula. Committees number from 4 to 16 members.</li>
    </ul>

    <h4 class="text-xl font-semibold mt-4">What if my name appears on a committee and I don’t have an interest in that committee?</h4>
    <ul class="list-disc list-inside">
    ...
    <h4 class="text-xl font-semibold mt-4">I never hear from the chairperson. We rarely have meetings. I don’t know what’s going on.</h4>
    <ul class="list-disc list-inside">
      <li>
        Collaborate with the Committee Chair to revisit the overall purpose, strategies, and short- and long-term objectives of the committee. Express your concerns and offer support. Perhaps there are ways you and others can help the Chair with the committee process.
      </li>
    </ul>

    <h4 class="text-xl font-semibold mt-4">Are there term limits for committee chairs?</h4>
    <ul class="list-disc list-inside">
      <li>No. Each President appoints or sanctions Committee Chairs and contributes ideas for committee representation.</li>
    </ul>

    <h4 class="text-xl font-semibold mt-4">How are committees held accountable for their contributions?</h4>
    <ul class="list-disc list-inside">
    ...
    <h4 class="text-xl font-semibold mt-4">What is the interface between the BOD and committees?</h4>
    <ul class="list-disc list-inside">
      <li>
        To quote the Yearbook: Committees generally work with and through the Club staff. They establish programs, policies, and procedures in their respective areas and advise the President and the Business Manager. Committee chairpersons should convene their committees in advance of encampment and several times during the season, where possible. Member suggestions and/or complaints should be addressed to the appropriate committee chairperson.
      </li>
