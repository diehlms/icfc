        ...
        {#if backBayBilges.length > 0}
          {#each backBayBilges as backBayBilge (backBayBilge.id)}
            <li class="list-group-item">
              ...
              {#if isAdmin}
                <button class="btn btn-red btn-sm float-right" on:click={(e) => deleteDoc(e, backBayBilge.id)}>
                  🗑️
                </button>
              {/if}
            </li>
        ...
        {#if dailyBilges.length > 0}
          {#each dailyBilges as dailyBilge (dailyBilge.id)}
            <li class="list-group-item">
              ...
              {#if isAdmin}
                <button class="btn btn-red btn-sm float-right" on:click={(e) => deleteDoc(e, dailyBilge.id)}>
                  🗑️
                </button>
              {/if}
            </li>
