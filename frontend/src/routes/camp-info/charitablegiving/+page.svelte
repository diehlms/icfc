<div class="reactPageAppContainer">
  <h1 class="text-3xl font-bold my-4">Charitable Giving</h1>
  ...
  <div class="text-container mt-4">
    <p>
      Both the Endowment and Charitable Gift Funds represent strategic priorities for Iron City: the Endowment to ensure the Club’s long-term financial future & stability, and the Charitable Gift Fund to contribute to the needs of the Greater Parry Sound community.
    </p>
    <p>
    ...
    <p>
      This fund is used for charitable purposes that benefit the Georgian Bay area. The Fund has contributed to community projects such as Parry Sound High School “First Generation” scholarships, the West Parry Sound Health Centre’s Nurses’ Skills Upgrade Program, the Festival of the Sound, the Georgian Bay Land Trust, and Georgian Bay Forever.
    </p>
    <p>
      Donations to this Fund, managed by The Pittsburgh Foundation ('TPF'), are tax deductible when made directly to TPF for Iron City Fishing Club Charitable Gift Fund. Contributions can be made in US funds online at <a href="https://community.pittsburghfoundation.org/page.aspx?pid=298&fid=UFxl2d4w9r8%3d&fdesc=akeoWcyY1DqiNZlcPVg5IG4X%2b9z3rivZsbvCHuNZCfGARFwY%2bSFiStdrINVJsG5w" class="text-blue-600 underline" target="_blank">Pittsburgh Foundation</a> using Visa or MasterCard, or via a transfer of marketable securities, or by check mailed to The Pittsburgh Foundation, attn.: Kelly Uranker, Five PPG Place, Suite 250, Pittsburgh, PA 15222-5414. Her phone number is 412-394-2604, ext. 204, and her email is <em>urankerk@pghfdn.org</em>.
    </p>
  </div>
</div>
