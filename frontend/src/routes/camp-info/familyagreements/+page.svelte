<div class="reactPageAppContainer">
  <h1 class="text-3xl font-bold my-4">Family Agreements</h1>

  <div class="bg-blue-100 border border-blue-500 text-blue-700 px-4 py-3 rounded">
    <h2 class="font-semibold">March 30, 2012</h2>
    <p>Club Policy Regarding Family Agreements relating to ICFC expense sharing and membership transfer</p>
  </div>

  <div class="text-container mt-4">
    <p>
      The Club is aware that over the years quite a few ICFC member families have entered into private agreements among family members to address and govern the sharing of ICFC-related expenses (including cottage ownership, cottage maintenance, and dues) among family members. In some instances, family agreements also address the subjects of membership status and transfers of membership among family members.
    </p>
    <p>
      The Club recognizes that such agreements can be useful means of resolving uncertainty regarding the issues that they address. The Club believes that it is appropriate for family members to enter into such agreements when they desire to do so. The Club will honor outcomes dictated by such agreements where the outcomes are consistent with existing Club By-Laws.
    </p>
    <p>
